...
import metisMenu from "./metisMenuCustom";
              ...
              <div className="dropdown">
                ...
                <Dropdown className="ml-0">
                  <Dropdown.Toggle
                    variant="light"
                    id="dropdown-basic"
                    className="user-name dropdown_btn"
                  >
                    <strong>فرشید قلج خانی</strong>
                  </Dropdown.Toggle>

                  <Dropdown.Menu>
                    <Link className="dropdown-item" to="/page-profile">
                      <i className="icon-user"></i>پروفایل
                    </Link>
                    <Link className="dropdown-item" to="/app-inbox">
                      <i className="icon-envelope-open"></i>پیام ها
                    </Link>
                    ...
                    <Link className="dropdown-item" to="/login">
                      <i className="icon-power"></i>خروج کاربر
                    </Link>
                  </Dropdown.Menu>
                </Dropdown>
